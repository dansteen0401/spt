				...
				<div id="content-box">
					<div id="post-body">
						<div <?php post_class('post-single'); ?>>
							...
							<ul class="link-pages">	
								<li class="next-link"><?php esc_url(previous_image_link( '%link', '<i class="fa fa-chevron-right"></i><strong>'.__('Next', 'spt').'</strong> <span>IMAGE</span>' )); ?></li>
								<li class="previous-link"><?php esc_url(next_image_link( '%link', '<i class="fa fa-chevron-left"></i><strong>'.__('Previous', 'spt').'</strong> <span>IMAGE</span>' )); ?></li>
							</ul>
