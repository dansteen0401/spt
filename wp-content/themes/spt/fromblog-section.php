...
$blog_bg_image = $spt_theme_options['blog_bg_image'];
$blog_cat = $spt_theme_options['blog_cat'];
$num_posts = $spt_theme_options['num_posts'];
...
<?php } ?>
	<div id="from-blog-wrap">
		<div>
		<h2 class="boxtitle wow bounceInLeft" data-wow-delay="0.1s"><?php echo esc_attr($spt_theme_options['blog_section_title']); ?></h2>
